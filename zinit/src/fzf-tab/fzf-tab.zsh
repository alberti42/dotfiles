...
function __fzf_tab_init_hook() {
  ...
  zstyle ':fzf-tab:complete:(kill|ps):*' fzf-preview "__zcompile_if_needed_and_source '${script_path:h}/__fzf_preview_kill.zsh' && __fzf_preview_kill \"\$word\" \"\$group\""

  # give a preview of commandline arguments when completing `killall`
  zstyle ':fzf-tab:complete:(killall):*' fzf-preview "__zcompile_if_needed_and_source '${script_path:h}/__fzf_preview_killall.zsh' && __fzf_preview_killall \"\$word\" \"\$group\""
  ...
  # preview for files
  zstyle ":fzf-tab:complete:*:*" fzf-preview "__zcompile_if_needed_and_source '${script_path:h}/__fzf_preview_file.zsh' && __fzf_preview_file \$realpath"
