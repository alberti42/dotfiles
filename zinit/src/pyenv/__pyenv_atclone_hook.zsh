...
function __pyenv_atclone_hook() {
  ...
  ln -sf $ZINIT[PLUGINS_DIR]/pyenv---doctor $PYENV_ROOT/plugins/pyenv-doctor &&
  ln -sf $ZINIT[PLUGINS_DIR]/pyenv---update $PYENV_ROOT/plugins/pyenv-update &&
  ...
  gsed -i"" 's@^source .*/completions/pyenv\.zsh\s*@#&@' zi_pyenv_init.zsh &&
